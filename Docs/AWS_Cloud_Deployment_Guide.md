...
- [`Clinic_Management_System_PRD.md`](./Clinic_Management_System_PRD.md) — product scope (v1.6), shipped features, **§12.3** production backlog, and **§12.3.13** enhancements to shipped modules.
